...
end-to-end execution of the solution notebook. The learner `lab.ipynb` is not executed
here; its stubs fail by design.
"""
...
def test_learner_has_stubs_solution_does_not(solution_nb):
    lab = solution_nb.parent.parent.parent / "labs/05-agents-orchestration/lab.ipynb"
